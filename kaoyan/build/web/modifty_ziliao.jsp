<%-- 
    Document   : modifty_ziliao
    Created on : 2017-4-20, 2017-4-20 14:56:04
    Author     : Baixin
--%>
        ...
        <div class="wrapper col4">
            <div id="container">
                ...
                <c:forEach var="p" items="${tlist}" varStatus="s">
                    <form action="modifty_ziliao" method="post" name="form">
                    <div style="margin-left:30%;font-size: 20px;">  
                        ...
                        <h2 style="font-size:25px">入学年份：</h2> <input type="text" value="${p.interyear}" name="interyear">
                        <h2 style="font-size:25px">本科院校：</h2> <input type="text" value="${p.benke}" name="benke">
                        <h2 style="font-size:25px">报考院校：</h2> <input type="text" value="${p.baokao}" name="baokao">
                        <h2 style="font-size:25px">报考专业：</h2> <input type="text" value="${p.major}" name="major">
                        <h2 style="font-size:25px">用户邮箱：</h2> <input type="text" value="${p.mail}" name="mail">
                        <br>
